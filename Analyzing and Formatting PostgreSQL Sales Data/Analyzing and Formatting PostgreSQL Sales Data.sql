...
-- 2. Import records from the dataset CSV source via the "pgAdmin 4" interface


-- 3. View the data to understand its structure, column names, data types, and overall content
